    ...
    return ( <section id="home" className="min-h-screen flex items-center justify-center relative">
        ...
        <RevealOnScroll>
            ...
            <div className="text-center z-10 px-4">
                ...
                Profesional versátil con experiencia en atención al cliente, operaciones técnicas y desarrollo de software.
                Hábil en comunicación bilingüe, resolución de problemas y programación con Java, JavaScript y SQL.
                Destacado por mi precisión, enfoque en el cliente y adaptabilidad, busco contribuir en roles que
                combinen excelencia operativa y desarrollo tecnológico.
                </p>
